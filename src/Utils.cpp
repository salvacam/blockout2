...
// #else
//   char blockoutHome[512];// = getenv("BL2_HOME");
//   sprintf(blockoutHome, "%s", getenv("BL2_HOME"));
// #endif

//   if( blockoutHome==NULL ) {
//     printf("BL2_HOME environment variable if not defined !\n");
//     printf("Please set the BL2_HOME to the BlockOut II installation directory (ex: BL2_HOME=/usr/local/bl2).\n");
//     // return FALSE;
//     sprintf(blockoutHome, "%s", homePath);
//   } else {
//     sprintf(bl2Home, "%s", blockoutHome);
//   }
#if !defined(PLATFORM_PSP) && !defined(PLATFORM_PSVITA)
  char bl2Dir[512];
